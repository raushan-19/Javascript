// Create an arrow function that takes a string as an argument & returns the number of vowels in the string.

let countVowel = (str) => {   // creating function & entering a parameter "str" 
...
countVowel("Raushan")  // calling the function and entering the value into it  